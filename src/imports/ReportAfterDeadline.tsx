import svgPaths from "./svg-lscmtpnyoz";
  ...
  return (
    ...
    >
      <div className="flex flex-col font-['Exo:Bold',_sans-serif] font-bold justify-center leading-[0] relative shrink-0 text-[#f9fffc] text-[18px] text-center text-nowrap tracking-[0.36px]">
        <p className="adjustLetterSpacing block leading-[1.5] whitespace-pre">Submit</p>
      </div>
    </div>
  );
}
...
function PrimaryButton() {
  return (
    <div
      className="absolute bottom-[115px] h-[46px] left-1/2 overflow-clip rounded-[10px] translate-x-[-50%] w-[343px]"
  ...
  return (
    <div className="relative shrink-0 size-5" data-name="charm:tick">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 20">
        <g id="charm:tick">
          <rect fill="url(#paint0_linear_3_3651)" height="20" rx="10" width="20" />
          <path
            d={svgPaths.p717cc0}
            id="Vector"
        ...
        <defs>
          <linearGradient
            ...
            id="paint0_linear_3_3651"
            x1="10.03"
            x2="-58.9851"
            y1="-42.8261"
            y2="-7.75768"
          >
            <stop stopColor="#F12130" />
            <stop offset="0.532953" stopColor="#FB8F0E" />
            <stop offset="1" stopColor="#FFE42B" />
          </linearGradient>
        </defs>
      </svg>
    </div>
...
function Checkbox() {
  return (
    <div
      className="absolute bottom-[196px] box-border content-stretch flex flex-row gap-[8.575px] items-start justify-start left-1/2 p-0 translate-x-[-50%] w-[343px]"
      data-name="Checkbox"
    >
      <CharmTick />
      <div className="basis-0 font-['Exo:Medium',_sans-serif] font-medium grow leading-[0] min-h-px min-w-px relative shrink-0 text-[#000000] text-[16.078px] text-left">
        <p className="block leading-[normal]">Retain entries for next session</p>
      </div>
    </div>
  );
}
  ...
  return (
    <div className="bg-[rgba(255,238,186,0.7)] h-12 relative rounded-[50px] shrink-0 w-[325px]">
      <div className="h-12 overflow-clip relative w-[325px]">
        <div
          className="absolute font-['Exo:SemiBold',_sans-serif] font-semibold leading-[0] text-[#000000] text-[18px] text-center text-nowrap translate-x-[-50%]"
          style={{ top: "calc(50% - 12px)", left: "calc(50% + 0.5px)" }}
        >
          <p className="block leading-[normal] whitespace-pre">Submission window closed</p>
        </div>
      </div>
      <div
        aria-hidden="true"
        className="absolute border border-[#e1e1e1] border-solid inset-0 pointer-events-none rounded-[50px]"
      />
    </div>
  );
}
...
function Frame71661() {
  return (
    <div className="box-border content-stretch flex flex-col gap-4 items-center justify-start p-0 relative shrink-0">
      <div
        className="font-['Exo:Medium',_sans-serif] font-medium leading-[0] min-w-full relative shrink-0 text-[#000000] text-[16px] text-center"
        style={{ width: "min-content" }}
      >
        <p className="block leading-[normal]">Deadline to submission</p>
      </div>
      <Frame71657 />
    </div>
  );
...
function Frame71379() {
  return (
    <div className="box-border content-stretch flex flex-col gap-1.5 items-start justify-start p-0 relative shrink-0 w-full">
      <div className="font-['Exo:Medium',_sans-serif] font-medium leading-[0] relative shrink-0 text-[#222222] text-[14px] text-left w-full">
        <p className="block leading-[normal]">Year</p>
      </div>
      <EmailInput />
    </div>
  );
...
function BasilCaretDownOutline() {
  return (
    <div className="absolute left-3.5 size-3 top-[14.5px]" data-name="basil:caret-down-outline">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 12 12">
        <g id="basil:caret-down-outline">
          <path clipRule="evenodd" d={svgPaths.p1d6500} fill="var(--fill-0, black)" fillRule="evenodd" id="Vector" />
        </g>
      </svg>
    </div>
  );
...
function EmailInput1() {
  return (
    <div className="bg-[#ffffff] h-[41px] relative rounded-[5px] shrink-0 w-full" data-name="Email Input">
      <div className="h-[41px] overflow-clip relative w-full">
        <BasilCaretDownOutline />
        <div className="absolute font-['Exo:Medium',_sans-serif] font-medium leading-[0] left-3.5 text-[#222222] text-[16px] text-left text-nowrap top-2.5">
          <p className="block leading-[normal] whitespace-pre">August</p>
        </div>
      ...
      <div className="h-[41px] overflow-clip relative w-full">
        <div className="absolute font-['Exo:Medium',_sans-serif] font-medium leading-[0] left-3.5 text-[#222222] text-[16px] text-left text-nowrap top-2.5">
          <p className="leading-[normal] whitespace-pre">
            <span>{`2 `}</span>
            <span className="text-[#777575]">(Mon, 4 Aug - Sun, 10 Aug)</span>
          </p>
        </div>
...
function CuidaCaretDownOutline3() {
  return (
    <div className="relative shrink-0 size-[15px]" data-name="cuida:caret-down-outline">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 15 15">
        <g id="cuida:caret-down-outline">
          <path
            clipRule="evenodd"
            d={svgPaths.p35949240}
            fill="var(--fill-0, #879697)"
            fillRule="evenodd"
            id="Vector"
          />
        </g>
...
function EmailInput3() {
  return (
    <div className="bg-[rgba(255,255,255,0.5)] relative rounded-[5px] shrink-0 w-[343px]" data-name="Email Input">
      <div className="box-border content-stretch flex flex-row gap-2 items-center justify-start overflow-clip px-3.5 py-2.5 relative w-[343px]">
        <div className="basis-0 font-['Exo:Medium',_sans-serif] font-medium grow leading-[0] min-h-px min-w-px relative shrink-0 text-[#777575] text-[16px] text-left">
          <p className="block leading-[normal]">LCC</p>
        </div>
...
function Frame71370() {
  return (
    <div className="box-border content-stretch flex flex-col gap-1.5 items-start justify-start p-0 relative shrink-0 w-full">
      <div
        className="font-['Exo:Medium',_sans-serif] font-medium leading-[0] min-w-full relative shrink-0 text-[#222222] text-[14px] text-left"
        style={{ width: "min-content" }}
      >
        <p className="block leading-[normal]">Specific LAM Church</p>
      </div>
      <EmailInput3 />
    </div>
  );
...
function EmailInput4() {
  return (
    <div className="bg-[#ffffff] h-[41px] relative rounded-[5px] shrink-0 w-full" data-name="Email Input">
      <div className="h-[41px] overflow-clip relative w-full">
        <div className="absolute font-['Exo:Medium',_sans-serif] font-medium leading-[0] left-3.5 text-[#222222] text-[16px] text-left text-nowrap top-2.5">
          <p className="block leading-[normal] whitespace-pre">Service Management</p>
        </div>
...
function Frame71372() {
  return (
    <div className="box-border content-stretch flex flex-col gap-1.5 items-start justify-start p-0 relative shrink-0 w-full">
      <div className="font-['Exo:Medium',_sans-serif] font-medium leading-[0] relative shrink-0 text-[#222222] text-[14px] text-left w-full">
        <p className="block leading-[normal]">Directorate</p>
      </div>
      <EmailInput4 />
    </div>
  );
...
function EmailInput5() {
  return (
    <div className="bg-[rgba(255,255,255,0.5)] relative rounded-[5px] shrink-0 w-[343px]" data-name="Email Input">
      <div className="box-border content-stretch flex flex-row gap-2 items-center justify-start overflow-clip px-3.5 py-2.5 relative w-[343px]">
        <div className="basis-0 font-['Exo:Medium',_sans-serif] font-medium grow leading-[0] min-h-px min-w-px relative shrink-0 text-[#777575] text-[16px] text-left">
          <p className="block leading-[normal]">Ms. Peace Anagwu</p>
        </div>
      </div>
      <div
        aria-hidden="true"
...
function Frame71373() {
  return (
    <div className="box-border content-stretch flex flex-col gap-1.5 items-start justify-start p-0 relative shrink-0 w-full">
      <div
        className="font-['Exo:Medium',_sans-serif] font-medium leading-[0] min-w-full relative shrink-0 text-[#222222] text-[13px] text-left"
        style={{ width: "min-content" }}
      >
        <p className="block leading-[normal]">Director</p>
      </div>
      <EmailInput5 />
    </div>
  );
...
function EmailInput6() {
  return (
    <div className="bg-[#ffffff] h-[41px] relative rounded-[5px] shrink-0 w-full" data-name="Email Input">
      <div className="h-[41px] overflow-clip relative w-full">
        <div className="absolute font-['Exo:Medium',_sans-serif] font-medium leading-[0] left-3.5 text-[#222222] text-[16px] text-left text-nowrap top-2.5">
          <p className="block leading-[normal] whitespace-pre">Brand Management</p>
        </div>
...
function CharmTick1() {
  return (
    <div
      className="absolute left-[127px] size-5 translate-y-[-50%]"
      data-name="charm:tick"
      style={{ top: "calc(50% + 0.5px)" }}
    >
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 20">
        <g id="charm:tick">
          <rect fill="url(#paint0_linear_3_2824)" height="20" rx="10" width="20" />
          <path
            d={svgPaths.p717cc0}
            id="Vector"
            stroke="var(--stroke-0, white)"
...
function EmailInput7() {
  return (
    <div className="bg-[#ffffff] h-[41px] relative rounded-[5px] shrink-0 w-[161px]" data-name="Email Input">
      <div className="h-[41px] overflow-clip relative w-[161px]">
        <div
          className="absolute font-['Exo:Medium',_sans-serif] font-medium leading-[0] left-3.5 text-[#222222] text-[16px] text-left text-nowrap"
      ...
      <div
        aria-hidden="true"
        className="absolute border border-[#f65c1e] border-solid inset-0 pointer-events-none rounded-[5px] shadow-[0px_1px_2px_0px_rgba(16,24,40,0.05)]"
      />
    </div>
  );
}
...
function Frame71392() {
  return (
    <div className="box-border content-stretch flex flex-row gap-[21px] items-start justify-start p-0 relative shrink-0">
      <EmailInput7 />
      <EmailInput8 />
    </div>
  );
  ...
  return (
    <div className="box-border content-stretch flex flex-col gap-1.5 items-start justify-start p-0 relative shrink-0 w-full">
      <div
        ...
        style={{ width: "min-content" }}
      >
        <p className="block leading-[normal]">Team</p>
      </div>
      <Frame71392 />
    </div>
  );
...
function EmailInput9() {
  return (
    <div className="bg-[rgba(255,255,255,0.5)] relative rounded-[5px] shrink-0 w-[343px]" data-name="Email Input">
      <div className="box-border content-stretch flex flex-row gap-2 items-center justify-start overflow-clip px-3.5 py-2.5 relative w-[343px]">
        <div className="basis-0 font-['Exo:Medium',_sans-serif] font-medium grow leading-[0] min-h-px min-w-px relative shrink-0 text-[#777575] text-[16px] text-left">
          <p className="block leading-[normal]">Ms. Ozochielo Chinaza Faith</p>
        </div>
      </div>
      <div
        aria-hidden="true"
  ...
  return (
    <div className="box-border content-stretch flex flex-col gap-1.5 items-start justify-start p-0 relative shrink-0 w-full">
      <div
        ...
        style={{ width: "min-content" }}
      >
        <p className="block leading-[normal]">Departmental Leader</p>
      </div>
      <EmailInput9 />
    </div>
  );
...
function EmailInput10() {
  return (
    <div className="bg-[rgba(255,255,255,0.5)] relative rounded-[5px] shrink-0 w-[343px]" data-name="Email Input">
      <div className="box-border content-stretch flex flex-row gap-2 items-center justify-start overflow-clip px-3.5 py-2.5 relative w-[343px]">
        <div className="basis-0 font-['Exo:Medium',_sans-serif] font-medium grow leading-[0] min-h-px min-w-px relative shrink-0 text-[#777575] text-[16px] text-left">
          <p className="block leading-[normal]">Mr. Joel Mgbikeh</p>
        </div>
      </div>
      <div
        aria-hidden="true"
  ...
  return (
    <div className="box-border content-stretch flex flex-col gap-1.5 items-start justify-start p-0 relative shrink-0 w-full">
      <div
        ...
        style={{ width: "min-content" }}
      >
        <p className="block leading-[normal]">Asst. Departmental Leader</p>
      </div>
      <EmailInput10 />
    </div>
  );
...
function Frame71378() {
  return (
    <div className="box-border content-stretch flex flex-col gap-1.5 items-start justify-start p-0 relative shrink-0 w-full">
      <div className="font-['Exo:Medium',_sans-serif] font-medium leading-[0] relative shrink-0 text-[#222222] text-[14px] text-left w-full">
        <p className="block leading-[normal]">Current Membership Strength</p>
      </div>
      <EmailInput11 />
    </div>
  );
...
function Frame71380() {
  return (
    <div className="box-border content-stretch flex flex-col gap-6 items-start justify-start p-0 relative shrink-0 w-full">
      <div className="font-['Exo:SemiBold',_sans-serif] font-semibold h-[25px] leading-[0] relative shrink-0 text-[#000000] text-[18.885px] text-left w-full">
        <p className="block leading-[normal]">GENERAL INFO</p>
      </div>
      <Frame71371 />
    </div>
  );
  ...
  return (
    <div className="box-border content-stretch flex flex-col gap-1.5 items-start justify-start p-0 relative shrink-0 w-full">
      <div
        ...
        style={{ width: "min-content" }}
      >
        <p className="block leading-[normal]">Was Departmental Leader Active This Week?</p>
      </div>
      <Frame71393 />
    </div>
  );
  ...
  return (
    <div className="box-border content-stretch flex flex-col gap-1.5 items-start justify-start p-0 relative shrink-0 w-full">
      <div
        ...
        style={{ width: "min-content" }}
      >
        <p className="block leading-[normal]">Was Asst. Departmental Leader Active This Week?</p>
      </div>
      <Frame71394 />
    </div>
  );
...
function Frame71396() {
  return (
    <div className="box-border content-stretch flex flex-col gap-1.5 items-start justify-start p-0 relative shrink-0 w-full">
      <div className="font-['Exo:Medium',_sans-serif] font-medium leading-[0] relative shrink-0 text-[#222222] text-[14px] text-left w-full">
        <p className="block leading-[normal]">Number of Active Departmental Officers This Week</p>
      </div>
      <EmailInput16 />
    </div>
  );
...
function Frame71383() {
  return (
    <div className="box-border content-stretch flex flex-col gap-5 items-start justify-start p-0 relative shrink-0 w-full">
      <div className="font-['Exo:Medium',_sans-serif] font-medium leading-[0] relative shrink-0 text-[#f97416] text-[15.885px] text-left text-nowrap">
        <p className="block leading-[normal] whitespace-pre">1. Active Departmental Leadership</p>
      </div>
      <Frame71382 />
    </div>
  );
...
function Frame71397() {
  return (
    <div className="box-border content-stretch flex flex-col gap-1.5 items-start justify-start p-0 relative shrink-0 w-full">
      <div className="font-['Exo:Medium',_sans-serif] font-medium leading-[0] relative shrink-0 text-[#222222] text-[14px] text-left w-full">
        <p className="block leading-[normal]">Total Number of Members Present in Service</p>
      </div>
      <EmailInput17 />
    </div>
  );
...
function Frame71398() {
  return (
    <div className="box-border content-stretch flex flex-col gap-1.5 items-start justify-start p-0 relative shrink-0 w-full">
      <div className="font-['Exo:Medium',_sans-serif] font-medium leading-[0] relative shrink-0 text-[#222222] text-[14px] text-left w-full">
        <p className="block leading-[normal]">Total Numbers of Members That Actively Served In Service (If on duty)</p>
      </div>
      <EmailInput18 />
    </div>
  );
...
function Frame71384() {
  return (
    <div className="box-border content-stretch flex flex-col gap-5 items-start justify-start p-0 relative shrink-0 w-full">
      <div className="font-['Exo:Medium',_sans-serif] font-medium leading-[0] relative shrink-0 text-[#f97416] text-[15.885px] text-left text-nowrap">
        <p className="block leading-[normal] whitespace-pre">2. Wednesday Service Report</p>
      </div>
      <Frame71399 />
    </div>
  );
...
function Frame71400() {
  return (
    <div className="box-border content-stretch flex flex-col gap-1.5 items-start justify-start p-0 relative shrink-0 w-full">
      <div className="font-['Exo:Medium',_sans-serif] font-medium leading-[0] relative shrink-0 text-[#222222] text-[14px] text-left w-full">
        <p className="block leading-[normal]">Total Number of Members Present in Services</p>
      </div>
      <EmailInput19 />
    </div>
  );
...
function Frame71401() {
  return (
    <div className="box-border content-stretch flex flex-col gap-1.5 items-start justify-start p-0 relative shrink-0 w-full">
      <div className="font-['Exo:Medium',_sans-serif] font-medium leading-[0] relative shrink-0 text-[#222222] text-[14px] text-left w-full">
        <p className="block leading-[normal]">Total Numbers of Members That Actively Served In Services (If on duty)</p>
      </div>
      <EmailInput20 />
    </div>
  );
...
function Frame71385() {
  return (
    <div className="box-border content-stretch flex flex-col gap-5 items-start justify-start p-0 relative shrink-0 w-full">
      <div className="font-['Exo:Medium',_sans-serif] font-medium leading-[0] relative shrink-0 text-[#f97416] text-[15.885px] text-left text-nowrap">
        <p className="block leading-[normal] whitespace-pre">3. Sunday Service Report</p>
      </div>
      <Frame71402 />
    </div>
  );
...
function Frame71625() {
  return (
    <div className="box-border content-stretch flex flex-row font-['Exo:Medium',_sans-serif] font-medium gap-2 items-center justify-start leading-[0] p-0 relative shrink-0 text-[15px] text-left text-nowrap">
      ...
      <div className="relative shrink-0 text-[#222222]">
        <p className="block leading-[normal] text-nowrap whitespace-pre">00</p>
      </div>
    </div>
  );
}
...
function StashCaretDownDuotone() {
  return (
    <div className="relative shrink-0 size-5" data-name="stash:caret-down-duotone">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 20">
        <g id="stash:caret-down-duotone">
          <path d={svgPaths.p1df91080} fill="var(--fill-0, #222222)" id="Vector" />
        </g>
      </svg>
    </div>
  );
  ...
  return (
    <div className="box-border content-stretch flex flex-row gap-0.5 items-center justify-start p-0 relative shrink-0">
      <div className="font-['Exo:Medium',_sans-serif] font-medium leading-[0] relative shrink-0 text-[#222222] text-[15px] text-center text-nowrap">
        <p className="block leading-[normal] whitespace-pre">PM</p>
      </div>
...
function Frame71652() {
  return (
    <div
      className="absolute box-border content-stretch flex flex-row gap-[13.333px] items-center justify-start p-0 translate-x-[-50%] translate-y-[-50%]"
      style={{ top: "calc(50% + 0.5px)", left: "calc(50% + 0.167px)" }}
    >
      <Frame71626 />
      <Frame71624 />
    </div>
...
function EmailInput21() {
  return (
    <div className="bg-[#ffffff] h-[41px] relative rounded-[5px] shrink-0 w-[149px]" data-name="Email Input">
...
function Frame71627() {
  return (
    <div className="box-border content-stretch flex flex-row font-['Exo:Medium',_sans-serif] font-medium gap-2 items-center justify-start leading-[0] p-0 relative shrink-0 text-[15px] text-left text-nowrap">
      ...
      <div className="relative shrink-0 text-[#222222]">
        <p className="block leading-[normal] text-nowrap whitespace-pre">36</p>
      </div>
    </div>
  );
}
      ...
      <div className="h-0 relative shrink-0 w-[13px]">
        <div className="absolute bottom-0 left-0 right-0 top-[-1px]">
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 13 1">
            <line id="Line 4" stroke="var(--stroke-0, black)" x2="13" y1="0.5" y2="0.5" />
          </svg>
        </div>
      </div>
      <EmailInput22 />
...
function CharmTick4() {
  return (
    <div className="bg-[#fffdf3] relative rounded-lg shrink-0 size-4" data-name="charm:tick">
      <div
        aria-hidden="true"
        className="absolute border-[#f65820] border-[1.6px] border-solid inset-0 pointer-events-none rounded-lg"
      />
    </div>
  );
}
...
function Checkbox1() {
  return (
    <div
      className="box-border content-stretch flex flex-row gap-[8.575px] items-center justify-start p-0 relative shrink-0 w-[343px]"
      data-name="Checkbox"
    >
      <CharmTick4 />
      <div className="basis-0 font-['Exo:Medium',_sans-serif] font-medium grow leading-[0] min-h-px min-w-px relative shrink-0 text-[#4b4b4b] text-[14px] text-left">
        <p className="block leading-[normal]">Meeting didn’t hold</p>
      </div>
    </div>
  );
}
  ...
  return (
    <div className="box-border content-stretch flex flex-col gap-1.5 items-start justify-start p-0 relative shrink-0 w-full">
      <div
        ...
        style={{ width: "min-content" }}
      >
        <p className="block leading-[normal]">Meeting Time Duration</p>
      </div>
      <Frame71653 />
    </div>
  );
...
function EmailInput23() {
  return (
    <div className="bg-[#ffffff] h-[41px] relative rounded-[5px] shrink-0 w-full" data-name="Email Input">
      <div className="h-[41px] overflow-clip relative w-full">
        <div className="absolute font-['Exo:Medium',_sans-serif] font-medium leading-[0] left-3.5 text-[#222222] text-[16px] text-left text-nowrap top-2.5">
          <p className="block leading-[normal] whitespace-pre">7</p>
        </div>
      </div>
      <div
        aria-hidden="true"
...
function Frame71404() {
  return (
    <div className="box-border content-stretch flex flex-col gap-1.5 items-start justify-start p-0 relative shrink-0 w-full">
      <div className="font-['Exo:Medium',_sans-serif] font-medium leading-[0] relative shrink-0 text-[#222222] text-[14px] text-left w-full">
        <p className="block leading-[normal]">Total Numbers of Members Present In Meeting</p>
      </div>
      <EmailInput23 />
    </div>
  );
...
function Frame71386() {
  return (
    <div className="box-border content-stretch flex flex-col gap-5 items-start justify-start p-0 relative shrink-0 w-full">
      <div className="font-['Exo:Medium',_sans-serif] font-medium leading-[0] relative shrink-0 text-[#f97416] text-[15.885px] text-left text-nowrap">
        <p className="block leading-[normal] whitespace-pre">4. Official Departmental Meeting</p>
      </div>
      <Frame71405 />
    </div>
  );
...
function Frame71406() {
  return (
    <div className="box-border content-stretch flex flex-col gap-1.5 items-start justify-start p-0 relative shrink-0 w-full">
      <div className="font-['Exo:Medium',_sans-serif] font-medium leading-[0] relative shrink-0 text-[#222222] text-[14px] text-left w-full">
        <p className="block leading-[normal]">{`Total Numbers of Members Not In Services & Meetings This Week`}</p>
      </div>
      <EmailInput24 />
    </div>
  );
...
function Frame71408() {
  return (
    <div className="box-border content-stretch flex flex-col gap-1.5 items-start justify-start p-0 relative shrink-0 w-full">
      <div className="font-['Exo:Medium',_sans-serif] font-medium leading-[0] relative shrink-0 text-[#222222] text-[14px] text-left w-full">
        <p className="block leading-[normal]">Total Numbers of Members Officially Called or Visited This Week</p>
      </div>
      <EmailInput25 />
    </div>
  );
...
function Frame71387() {
  return (
    <div className="box-border content-stretch flex flex-col gap-5 items-start justify-start p-0 relative shrink-0 w-full">
      <div className="font-['Exo:Medium',_sans-serif] font-medium leading-[0] relative shrink-0 text-[#f97416] text-[15.885px] text-left text-nowrap">
        <p className="block leading-[normal] whitespace-pre">5. Members Weekly Follow-up</p>
      </div>
      <Frame71407 />
      <Frame71409 />
    </div>
...
function EmailInput26() {
  return (
    <div className="bg-[#ffffff] h-[41px] relative rounded-[5px] shrink-0 w-full" data-name="Email Input">
      <div className="h-[41px] overflow-clip relative w-full">
        <div className="absolute font-['Exo:Medium',_sans-serif] font-medium leading-[0] left-3.5 text-[#222222] text-[16px] text-left text-nowrap top-2.5">
          <p className="block leading-[normal] whitespace-pre">N25,000</p>
        </div>
      </div>
      <div
        aria-hidden="true"
...
function Frame71410() {
  return (
    <div className="box-border content-stretch flex flex-col gap-1.5 items-start justify-start p-0 relative shrink-0 w-full">
      <div className="font-['Exo:Medium',_sans-serif] font-medium leading-[0] relative shrink-0 text-[#222222] text-[14px] text-left w-full">
        <p className="block leading-[normal]">Total Departmental Funds Raised</p>
      </div>
      <EmailInput26 />
    </div>
  );
...
function EmailInput27() {
  return (
    <div className="bg-[#ffffff] h-[41px] relative rounded-[5px] shrink-0 w-full" data-name="Email Input">
      <div className="h-[41px] overflow-clip relative w-full">
        <div className="absolute font-['Exo:Medium',_sans-serif] font-medium leading-[0] left-3.5 text-[#222222] text-[16px] text-left text-nowrap top-2.5">
          <p className="block leading-[normal] whitespace-pre">N5,000</p>
        </div>
      </div>
      <div
        aria-hidden="true"
...
function Frame71412() {
  return (
    <div className="box-border content-stretch flex flex-col gap-1.5 items-start justify-start p-0 relative shrink-0 w-full">
      <div className="font-['Exo:Medium',_sans-serif] font-medium leading-[0] relative shrink-0 text-[#222222] text-[14px] text-left w-full">
        <p className="block leading-[normal]">Total Dues Collected This Week</p>
      </div>
      <EmailInput27 />
    </div>
  );
...
function Frame71414() {
  return (
    <div className="box-border content-stretch flex flex-col gap-1.5 items-start justify-start p-0 relative shrink-0 w-full">
      <div className="font-['Exo:Medium',_sans-serif] font-medium leading-[0] relative shrink-0 text-[#222222] text-[14px] text-left w-full">
        <p className="block leading-[normal]">Total Amount Raised By The Department This Week</p>
      </div>
      <EmailInput28 />
    </div>
  );
...
function EmailInput29() {
  return (
    <div className="bg-[#ffffff] h-[250px] relative rounded-[5px] shrink-0 w-full" data-name="Email Input">
      <div className="h-[250px] overflow-clip relative w-full">
        <div className="absolute font-['Exo:Medium',_sans-serif] font-medium leading-[normal] left-3.5 text-[#222222] text-[16px] text-left text-nowrap top-2.5 whitespace-pre">
          <p className="block mb-0">1. John Doe - N2,000</p>
          <p className="block">2. Jamie Doe - N3,000</p>
        </div>
      </div>
      <div
        aria-hidden="true"
...
function Frame71416() {
  return (
    <div className="box-border content-stretch flex flex-col gap-1.5 items-start justify-start p-0 relative shrink-0 w-full">
      <div className="font-['Exo:Medium',_sans-serif] font-medium leading-[0] relative shrink-0 text-[#222222] text-[14px] text-left w-full">
        <p className="block leading-[normal]">{`Names of Givers & Amount Given`}</p>
      </div>
      <EmailInput29 />
    </div>
  );
...
function Frame71388() {
  return (
    <div className="box-border content-stretch flex flex-col gap-5 items-start justify-start p-0 relative shrink-0 w-full">
      <div className="font-['Exo:Medium',_sans-serif] font-medium leading-[0] relative shrink-0 text-[#f97416] text-[15.885px] text-left text-nowrap">
        <p className="block leading-[normal] whitespace-pre">6. Departmental Funds</p>
      </div>
      <Frame71411 />
      <Frame71413 />
      <Frame71415 />
...
function Frame71418() {
  return (
    <div className="box-border content-stretch flex flex-col gap-1.5 items-start justify-start p-0 relative shrink-0 w-full">
      <div className="font-['Exo:Medium',_sans-serif] font-medium leading-[0] relative shrink-0 text-[#222222] text-[14px] text-left w-full">
        <p className="block leading-[normal]">Total Minor Expenditures This Week</p>
      </div>
      <EmailInput30 />
    </div>
  );
...
function Frame71420() {
  return (
    <div className="box-border content-stretch flex flex-col gap-1.5 items-start justify-start p-0 relative shrink-0 w-full">
      <div className="font-['Exo:Medium',_sans-serif] font-medium leading-[0] relative shrink-0 text-[#222222] text-[14px] text-left w-full">
        <p className="block leading-[normal]">Total Major Projects Funding This Week</p>
      </div>
      <EmailInput31 />
    </div>
  );
...
function EmailInput32() {
  return (
    <div className="bg-[#ffffff] h-[143px] relative rounded-[5px] shrink-0 w-full" data-name="Email Input">
...
function Frame71421() {
  return (
    <div className="box-border content-stretch flex flex-col gap-1.5 items-start justify-start p-0 relative shrink-0 w-full">
      <div className="font-['Exo:Medium',_sans-serif] font-medium leading-[0] relative shrink-0 text-[#222222] text-[14px] text-left w-full">
        <p className="block leading-[normal]">Details of Expenses and Exact Amount Spent</p>
      </div>
      <EmailInput32 />
    </div>
  );
...
function Frame71389() {
  return (
    <div className="box-border content-stretch flex flex-col gap-5 items-start justify-start p-0 relative shrink-0 w-full">
      <div className="font-['Exo:Medium',_sans-serif] font-medium leading-[0] relative shrink-0 text-[#f97416] text-[15.885px] text-left text-nowrap">
        <p className="block leading-[normal] whitespace-pre">{`7. Departmental Budget & Projects`}</p>
      </div>
      <Frame71419 />
      <Frame71423 />
    </div>
...
function CuidaCaretDownOutline12() {
  return (
    <div className="absolute left-[314px] size-[15px] top-1/2 translate-y-[-50%]" data-name="cuida:caret-down-outline">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 15 15">
        <g id="cuida:caret-down-outline">
...
function CuidaCaretDownOutline13() {
  return (
    <div className="absolute left-[314px] size-[15px] top-1/2 translate-y-[-50%]" data-name="cuida:caret-down-outline">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 15 15">
        <g id="cuida:caret-down-outline">
  ...
  return (
    <div className="box-border content-stretch flex flex-col gap-1.5 items-start justify-start p-0 relative shrink-0 w-full">
      <div
        ...
        style={{ width: "min-content" }}
      >
        <p className="block leading-[normal]">Did Your Team Wear Uniform This Week?</p>
      </div>
      <Frame71424 />
    </div>
  );
...
function EmailInput35() {
  return (
    <div className="bg-[#ffffff] h-[41px] relative rounded-[5px] shrink-0 w-full" data-name="Email Input">
      <div className="h-[41px] overflow-clip relative w-full">
        <div className="absolute font-['Exo:Medium',_sans-serif] font-medium leading-[0] left-3.5 text-[#222222] text-[16px] text-left text-nowrap top-2.5">
          <p className="block leading-[normal] whitespace-pre">Native Attire</p>
        </div>
      </div>
      <div
        aria-hidden="true"
...
function Frame71426() {
  return (
    <div className="box-border content-stretch flex flex-col gap-1.5 items-start justify-start p-0 relative shrink-0 w-full">
      <div className="font-['Exo:Medium',_sans-serif] font-medium leading-[0] relative shrink-0 text-[#222222] text-[14px] text-left w-full">
        <p className="block leading-[normal]">If Yes, Specify The Uniform</p>
      </div>
      <EmailInput35 />
    </div>
  );
...
function CuidaCaretDownOutline14() {
  return (
    <div className="absolute left-[314px] size-[15px] top-1/2 translate-y-[-50%]" data-name="cuida:caret-down-outline">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 15 15">
        <g id="cuida:caret-down-outline">
...
function CuidaCaretDownOutline15() {
  return (
    <div className="absolute left-[314px] size-[15px] top-1/2 translate-y-[-50%]" data-name="cuida:caret-down-outline">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 15 15">
        <g id="cuida:caret-down-outline">
  ...
  return (
    <div className="box-border content-stretch flex flex-col gap-1.5 items-start justify-start p-0 relative shrink-0 w-full">
      <div
        ...
        style={{ width: "min-content" }}
      >
        <p className="block leading-[normal]">Is the Uniform a New One?</p>
      </div>
      <Frame71427 />
    </div>
  );
...
function Frame71390() {
  return (
    <div className="box-border content-stretch flex flex-col gap-5 items-start justify-start p-0 relative shrink-0 w-full">
      <div className="font-['Exo:Medium',_sans-serif] font-medium leading-[0] relative shrink-0 text-[#f97416] text-[15.885px] text-left text-nowrap">
        <p className="block leading-[normal] whitespace-pre">8. Excellent Departmental Uniforms</p>
      </div>
      <Frame71429 />
    </div>
  );
...
function CuidaCaretDownOutline16() {
  return (
    <div className="absolute left-[314px] size-[15px] top-1/2 translate-y-[-50%]" data-name="cuida:caret-down-outline">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 15 15">
        <g id="cuida:caret-down-outline">
...
function EmailInput38() {
  return (
    <div className="bg-[#ffffff] h-[41px] relative rounded-[5px] shrink-0 w-[161px]" data-name="Email Input">
      <div className="h-[41px] overflow-clip relative w-[161px]">
        <div className="absolute font-['Exo:Medium',_sans-serif] font-medium leading-[0] left-3.5 text-[#222222] text-[16px] text-left text-nowrap top-2.5">
          <p className="block leading-[normal] whitespace-pre">Bad</p>
        </div>
        <CuidaCaretDownOutline16 />
      </div>
      <div
        aria-hidden="true"
        className="absolute border border-[#b4c4c5] border-solid inset-0 pointer-events-none rounded-[5px] shadow-[0px_1px_2px_0px_rgba(16,24,40,0.05)]"
...
function CuidaCaretDownOutline17() {
  return (
    <div className="absolute left-[314px] size-[15px] top-1/2 translate-y-[-50%]" data-name="cuida:caret-down-outline">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 15 15">
        <g id="cuida:caret-down-outline">
...
function EmailInput39() {
  return (
    <div className="bg-[#ffffff] h-[41px] relative rounded-[5px] shrink-0 w-[161px]" data-name="Email Input">
      <div className="h-[41px] overflow-clip relative w-[161px]">
        <div className="absolute font-['Exo:Medium',_sans-serif] font-medium leading-[0] left-3.5 text-[#222222] text-[16px] text-left text-nowrap top-2.5">
          <p className="block leading-[normal] whitespace-pre">Poor</p>
        </div>
        <CuidaCaretDownOutline17 />
      </div>
      <div
        aria-hidden="true"
        className="absolute border border-[#b4c4c5] border-solid inset-0 pointer-events-none rounded-[5px] shadow-[0px_1px_2px_0px_rgba(16,24,40,0.05)]"
...
function CuidaCaretDownOutline18() {
  return (
    <div className="absolute left-[314px] size-[15px] top-1/2 translate-y-[-50%]" data-name="cuida:caret-down-outline">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 15 15">
        <g id="cuida:caret-down-outline">
...
function CuidaCaretDownOutline19() {
  return (
    <div className="absolute left-[314px] size-[15px] top-1/2 translate-y-[-50%]" data-name="cuida:caret-down-outline">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 15 15">
        <g id="cuida:caret-down-outline">
...
function EmailInput41() {
  return (
    <div className="bg-[#ffffff] h-[41px] relative rounded-[5px] shrink-0 w-[161px]" data-name="Email Input">
      <div className="h-[41px] overflow-clip relative w-[161px]">
        <div className="absolute font-['Exo:Medium',_sans-serif] font-medium leading-[0] left-3.5 text-[#222222] text-[16px] text-left text-nowrap top-2.5">
          <p className="block leading-[normal] whitespace-pre">Excellent</p>
        </div>
        <CuidaCaretDownOutline19 />
      </div>
      <div
        aria-hidden="true"
        className="absolute border border-[#b4c4c5] border-solid inset-0 pointer-events-none rounded-[5px] shadow-[0px_1px_2px_0px_rgba(16,24,40,0.05)]"
  ...
  return (
    <div className="box-border content-stretch flex flex-col gap-1.5 items-start justify-start p-0 relative shrink-0 w-full">
      <div
        ...
        style={{ width: "min-content" }}
      >
        <p className="block leading-[normal]">How Do You Rate the Departmental Team’s Performance This Week?</p>
      </div>
      <Frame71656 />
    </div>
  );
...
function Frame71433() {
  return (
    <div className="box-border content-stretch flex flex-col gap-1.5 items-start justify-start p-0 relative shrink-0 w-full">
      <div className="font-['Exo:Medium',_sans-serif] font-medium leading-[0] relative shrink-0 text-[#222222] text-[14px] text-left w-full">
        <p className="block leading-[normal]">What Fresh Innovations Did the Team Add To Service Delivery This Week</p>
      </div>
      <EmailInput42 />
    </div>
  );
...
function Frame71434() {
  return (
    <div className="box-border content-stretch flex flex-col gap-1.5 items-start justify-start p-0 relative shrink-0 w-full">
      <div className="font-['Exo:Medium',_sans-serif] font-medium leading-[0] relative shrink-0 text-[#222222] text-[14px] text-left w-full">
        <p className="block leading-[normal]">Details of Fresh Innovations For the Week</p>
      </div>
      <EmailInput43 />
    </div>
  );
...
function Frame71391() {
  return (
    <div className="box-border content-stretch flex flex-col gap-5 items-start justify-start p-0 relative shrink-0 w-full">
      <div className="font-['Exo:Medium',_sans-serif] font-medium leading-[0] relative shrink-0 text-[#f97416] text-[15.885px] text-left text-nowrap">
        <p className="block leading-[normal] whitespace-pre">9. Excellent Delivery and Fresh Innovations</p>
      </div>
      <Frame71436 />
    </div>
  );
...
function Frame71437() {
  return (
    <div className="box-border content-stretch flex flex-col gap-[45px] items-start justify-start p-0 relative shrink-0 w-full">
      <Frame71383 />
...
function Frame71381() {
  return (
    <div className="box-border content-stretch flex flex-col gap-6 items-start justify-start p-0 relative shrink-0 w-full">
      <div className="font-['Exo:SemiBold',_sans-serif] font-semibold h-[25px] leading-[0] relative shrink-0 text-[#000000] text-[18.885px] text-left w-full">
        <p className="block leading-[normal]">THE REPORTS</p>
      </div>
      <Frame71437 />
    </div>
  );
...
function Frame71659() {
  return (
    <div className="box-border content-stretch flex flex-col gap-[50px] items-start justify-start p-0 relative shrink-0 w-full">
      <Frame71380 />
      <Frame71381 />
    </div>
  );
...
function Frame71662() {
  return (
    <div className="absolute box-border content-stretch flex flex-col gap-9 items-center justify-start left-[25px] p-0 top-[231px] w-[343px]">
      <Frame71661 />
      <Frame71659 />
    </div>
  );
...
function Frame139() {
  return (
    <div className="absolute box-border content-stretch flex flex-row gap-4 items-center justify-start left-5 p-0 top-1/2 translate-y-[-50%]">
      <div
        className="bg-center bg-cover bg-no-repeat shrink-0 size-11"
        data-name="lam-logo 1"
        style={{ backgroundImage: `url('${imgLamLogo1}')` }}
      />
      <div className="flex flex-col font-['Exo:SemiBold',_sans-serif] font-semibold justify-center leading-[0] relative shrink-0 text-[#000004] text-[14.778px] text-left w-[221px]">
  ...
  return (
    <div className="absolute left-[342px] size-[26px] top-1/2 translate-y-[-50%]" data-name="mdi:user-key-outline">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 26 26">
        <g id="mdi:user-key-outline">
          <path d={svgPaths.p9ae3c00} fill="var(--fill-0, black)" id="Vector" />
        </g>
      </svg>
    </div>
  );
...
function Navbar() {
  return (
    <div
      className="absolute bg-[#ffffff] h-[84px] left-0 overflow-clip shadow-[0px_1px_4px_0px_rgba(0,0,0,0.05)] top-28 w-[393px]"
      data-name="Navbar"
    >
      <Frame139 />
      <MdiUserKeyOutline />
...
export default function ReportAfterDeadline() {
  return (
    <div className="bg-[#fffdf3] relative size-full" data-name="Report (After deadline)">
      <Navbar />
      <ToolbarPro />
      <SearchBarPro />
      <PrimaryButton />
